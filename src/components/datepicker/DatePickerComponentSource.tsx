export const datePickerComponentSource = `
  ...
  return (
    <div className="relative   ">
      <div className="relative" onClick={() => setShowCalendar(!showCalendar)}>
        <input
          type="text"
          className="bg-background w-full rounded-md border border-gray-300 p-2 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
          readOnly
          value={format(selectedDate ?? new Date(), "P")}
          placeholder="Select Date"
        />
        <div className="hover:bg-secondary/85 group  absolute inset-y-1.5 right-1 h-8 w-8 rounded-full  bg-secondary hover:cursor-pointer">
